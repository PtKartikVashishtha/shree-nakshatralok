...
const schema = z.object({
  ...
  birthPlace: z
    ...
    .max(
      200,
      "Birth place must be 200 characters or less."
    ),
    ...
    const submission =
      await prisma.submission.create({
        data: {
          ...
          // Submission model currently has
          // "address", not "birthPlace".
          address: birthPlace,
    ...
    return NextResponse.json(
      {
        ...
        emailSent: true,
        message:
          "Your Janam Kundli request has been submitted successfully. We will contact you soon.",
        id: submission.id,
      },
      {
        status: 201,
